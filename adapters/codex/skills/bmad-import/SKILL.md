...
# you are at adapters/codex/skills/bmad-import/SKILL.md.

0. User invokes this skill with natural language, such as `Pathly bmad-import ...` or `Use Pathly bmad-import ...`.

...
# you are at adapters/claude-code/skills/plan/SKILL.md.

0. User runs `/pathly plan` or `/path plan` (or the legacy `plan`) with arguments describing the feature and rigor level.
1. Read `pathly/core/prompts/plan.md`.

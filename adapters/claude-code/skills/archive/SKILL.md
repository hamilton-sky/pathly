...
# you are at adapters/claude-code/skills/archive/SKILL.md.

0. User runs `/pathly archive` or `/path archive` (or the legacy `archive`) with an argument describing the feature name.
1. Read `pathly/core/prompts/archive.md`.

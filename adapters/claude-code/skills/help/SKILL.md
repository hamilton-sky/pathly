...
# you are at adapters/claude-code/skills/help/SKILL.md.

0. User runs `/pathly help` or `/path help` (or the legacy `help`) with an optional feature name argument.

1. Read `pathly/core/prompts/help.md`.

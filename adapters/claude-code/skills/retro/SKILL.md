...
# you are at adapters/claude-code/skills/retro/SKILL.md.

0. User runs `/pathly retro` or `/path retro` (or the legacy `retro`) with an argument describing the plan folder name.
1. Read `pathly/core/prompts/retro.md`.

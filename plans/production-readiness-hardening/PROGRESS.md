...
| 2 | 4–7 | S3, S4, S5, S6 | TODO | `pytest pathly-engine/tests/ -q` |
...
| 4 | Thread-based input timeout | `team_flow/manager.py` | 120s for ask(), 3600s for human block | 2 | TODO |
| 5 | Feedback loop return code | `team_flow/manager.py` | Check run_claude() result; escalate on failure | 2 | TODO |
| 6 | Git failure → SystemEvent | `team_flow/manager.py` | Emit before sys.exit; preserve event log | 2 | TODO |
| 7 | PID lockfile | `team_flow/manager.py` | Prevent two managers on same feature | 2 | TODO |

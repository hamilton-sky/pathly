...
| S3.1 | pathly go / status / doctor work from terminal without AI tool | Conv 3 | TODO |
| S4.1 | README and adapter docs match verified behavior | Conv 4 | TODO |
...
| 3 | Phase 3 | S3.1 | Conv 1 DONE | TODO | `pathly go "add password reset"`; `pytest tests/test_engine_cli.py -q` |
| 4 | Phase 4 | S4.1 | Convs 1-3 DONE | TODO | `pytest -q`; host smoke where available |
...
| 3 | Engine CLI | pathly-engine | pathly go / status / doctor from plain terminal without AI tool. | 3 | TODO | `pathly-engine/engine_cli/manager.py`, `tests/test_engine_cli.py` |
| 4 | Docs alignment | both | README and adapter docs match verified behavior. Public beta language only. | 4 | TODO | `README.md`, `pathly-adapters/README.md`, `pathly-engine/README.md`, adapter READMEs |

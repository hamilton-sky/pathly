...
|-------|-------|--------------|--------|
| S1.1 | Runtime entrypoints are canonical | Conv 1 | TODO |
...
|------|--------|---------|------------|--------|--------|
| 1 | Phase 1 | S1.1 | Baseline `pytest -q` green | TODO | `python -m pathly.cli --help`; `python -m pathly.team_flow --help`; `pathly --help`; `pytest -q` |
...
|---|-------|-------|-------------|------|--------|-----------|
| 1 | Stabilize package entrypoints | CLI/runtime | Make canonical package entrypoints work before cleanup. | 1 | TODO | `pathly/cli/`, `pathly/team_flow/`, `pyproject.toml`, `tests/` |
